    ...
    <div>
      ...
      <div className="mt-4 @container">
        <BasicTableWidget
          title={
            <div className="flex items-center gap-4">
              Sales assisted by Operators <PiQuestionMarkBold />
            </div>
          }
          variant="modern"
          // data={productsData}
        ...
        <BasicTableWidget
          title={
            <div className="flex items-center gap-4">
              Sales assisted by Flows <PiQuestionMarkBold />
            </div>
          }
          variant="modern"
          // data={productsData}
          ...
          enableSearch={false}
          className="mt-4 [&_.rc-table-content_table_tbody_tr:last-child_td]:border-0"
        />
      </div>
    </div>
  );
