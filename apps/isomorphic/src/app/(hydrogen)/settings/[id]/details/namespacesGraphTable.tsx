...
// const bars = [
//   { name: 'Fallback', value: 'newSales', color: '#2563eb' }, // cyan-600
//   { name: 'Spot', value: 'upgrades', color: '#60a5fa' }, // cyan-500
//   { name: 'On-Demand', value: 'Resellers', color: '#93c5fd' }, // sky-200
...
// export default function NamespacesGraphTable({
//   className,
// }: {
//   className?: string;
// }) {
...
//     <WidgetCard
//       title={
//         <Title as="h6" className="me-2 font-semibold">
//           COMPUTE COST PER NAMESPACE
//         </Title>
//       }
