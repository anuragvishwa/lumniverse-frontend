  ...
  return (
    <div className="@container">
      <div className="grid grid-cols-1 gap-6 @4xl:grid-cols-2 @7xl:grid-cols-12 3xl:gap-8">
        <WelcomeBanner
          title={<>Boost Your Sales with Predictive Bundles!</>}
          description="Enhance your customers' shopping experience by offering customized bundle deals. Easily set up predictive bundles in the app admin to attract more customers and increase your revenue."
          media={
