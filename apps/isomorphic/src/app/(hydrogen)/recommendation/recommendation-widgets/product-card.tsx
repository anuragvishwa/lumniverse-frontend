        ...
        <WelcomeBanner
          ...
          description={
            <div className="flex flex-col gap-4">
              <p>
                Recommendation lets you display various types of AI-based,
                statistic-based and manual recommendations for maximum
                cross-sell and upsell impact.
              </p>
              <p>
                Learn more about our recommendation best practices and how to
