...
import { MdCancel, MdChat, MdOutlineModeEdit } from 'react-icons/md';
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="fixed-bottom-right rounded-xl bg-white shadow-lg"
        ...
        <button
          className="fixed bottom-4 right-4 rounded-full bg-gradient-to-r from-violet-600 to-indigo-600 p-4 text-white shadow-lg transition-transform hover:scale-105"
