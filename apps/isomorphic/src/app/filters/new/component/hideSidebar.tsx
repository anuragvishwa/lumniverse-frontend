import { BsEyeSlash, BsPinAngle, BsXLg } from 'react-icons/bs';
    ...
    <div className="w-full border-l border-gray-300">
      ...
      <div className="p-5">
        <p className="mb-1 text-sm text-gray-500">
          This option is useful for hiding
          <strong>out-of-stock</strong> or <strong>out of season</strong>{' '}
          products.
        </p>
        <p className="text-sm text-gray-500">
          Remove products that meet the following conditions from the product
          list.
        </p>
        <Tab>
          <Tab.List>
