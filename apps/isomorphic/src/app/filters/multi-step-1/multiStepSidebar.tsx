...
import { Button, Checkbox, Input, Select, Text } from 'rizzui';
  ...
  return (
    ...
    >
      ...
      <SimpleBar className="h-[calc(100%-80px)]">
        {selectWidget?.value === 'widget layout' ? (
          <div className="px-6 pb-5 pt-5 dark:bg-gray-100/5 2xl:px-8 2xl:pt-6">
            <h2 className="mb-4 text-lg font-semibold">Widget Layout</h2>
            <div className="space-y-4">
              ...
              <div>
                <Input
                  label="Number of products per row on PC"
                  type="number"
                  size="sm"
                  variant="outline"
                  defaultValue={showProduct}
          ...
          <div className="px-6 pb-5 pt-5 dark:bg-gray-100/5 2xl:px-8 2xl:pt-6">
            ...
            <h2 className="mb-4 mt-6 text-lg font-semibold">Style Settings</h2>
            <div className="space-y-4">
              <div>
                <Select
                  options={options}
                  ...
                  variant="outline"
                  rounded="md"
                  value={options.find((option) => option.value === style)}
                  onChange={handleStyleChange}
                  className="mb-2 w-full"
                />{' '}
                {style === 'customization' && (
                  <Text as="span" className="mt-2 text-sm">
                    Style Customization will be applied for this bundle widget
                    only
                  </Text>
                )}
              </div>
                ...
                <div className="space-y-4">
                      ...
                      <Popover.Content>
                        <div>
                          <HexColorPicker
                            ...
                            onChange={(e) => handleHeaderTextColorChange(e)}
                          />
                  ...
                  <div>
                    <Select
                      ...
                      onChange={handleHeaderTextTransform}
                    />
                  </div>
                  ...
                  <div className="mb-4 flex flex-col gap-2">
                    ...
                    <div className="flex items-start gap-2">
                      ...
                      >
                        Save Bundle title settings above as Default for Classic
                        bundle
                      </label>
                    </div>
                    <Text as="span" className="text-sm text-gray-500">
                      The Default settings will apply to all Classic bundle.
                    </Text>
                  </div>
                </div>
              )}
